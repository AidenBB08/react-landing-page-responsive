...
export const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-center'>
     <header className="mt-3 fixed top-0 z-50 w-full bg-white/5 backdrop-blur-md px-10 py-3 mx-auto max-w-7xl rounded-[4rem]">
        <nav className=" flex items-center gap-4 px-4">
          ...
          {/* Middle nav items */}
          <div
              className="flex flex-col lg:flex-row flex-grow max-w-4xl lg:justify-center lg:items-center
          ...
          <div className="flex items-center gap-x-3">
            <button
              onClick={toggleTheme}
              className="outline-hidden flex items-center text-heading-2 rounded-full p-2 lg:p-3 border border-box-border cursor-pointer"
            >
              {theme === "dark" ? (
                <svg
