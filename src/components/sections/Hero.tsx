      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12 py-10">
        ...
        >
          ...
          <Paragraph className="mt-8">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Itaque assumenda, eius consequuntur ea, vitae eaque porro dolorem soluta dolores quaerat laudantium vel! Sunt, possimus error non modi nostrum excepturi libero.
          </Paragraph>
